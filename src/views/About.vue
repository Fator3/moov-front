<template>
  <v-container class="ma-0 pa-0 wrapper" fluid>
    <v-sheet id="headline" class="display-2">
      <span id="spacing-text" class="text-style">A nossa missão é te possibilitar viver<br />
        da melhor forma que pode!<br />
        Do seu jeito. <br />
        De acordo com suas necessidades.</span>
      <span class="text-style secondary--text">O tempo é agora. Bora viver? </span>
    </v-sheet>
    <v-sheet class="display-2">
      <v-row no-gutters>
        <v-col class="mb-6">
          <span class="text-style-secondary">Somos uma plataforma<br />
            desenvolvida para você<br />
            encontrar o melhor lugar <br />
            para viver!
          </span>
        </v-col>
        <v-col class="mb-6 d-flex justify-content-end" style="padding-bottom:20px;">
      ...
      <v-divider></v-divider>
      <v-row no-gutters >
        <v-col class="md-2 pa-1 d-flex justify-content-center">
          <div>
      ...
      <v-divider></v-divider>
      <v-row no-gutters="">
        <v-col class="md-6 pa-6">
          <div class="rect-before">
            <div class="img-container-over ">
              <img src="../assets/images/couple.png" class="img-align-top">
            </div>
          </div> 
        </v-col>
        <v-col class="md-6 pa-6">
          <span class="text-style-secondary">
    ...
    <v-divider style="margin-top: 6%; margin-bottom:4%;"></v-divider>
    <v-row no-gutters class="justify-content-center">
      <span class="text-style-tertiary">
        <span>Então,</span> qual vida você quer viver?
      </span>
    </v-row>
    <v-divider style="margin-top: 4%;"></v-divider>
    <v-row no-gutters class="justify-content-center text-style-tertiary spacing-row">
      <span class="justify-content-center">Fundadores</span>
    </v-row>
    <v-row no-gutters class="justify-content-center spacing-row">
      <v-col class="d-flex justify-content-center">
        <div>
            <img class="img-founders" src="../assets/images/handall.png">
            <span class="text-name-founders d-flex justify-content-center">Handall</span>
      ...
      <v-col class="d-flex justify-content-center">
        <div>
          <img class="img-founders img-spacing" src="../assets/images/andre.png">
      ...
      <v-col class="d-flex justify-content-center">
        <div>
          <img class="img-founders img-spacing" src="../assets/images/alexandre.png">
